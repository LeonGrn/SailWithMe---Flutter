                ...
                children: <Widget>[
                  Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image(
                        fit: BoxFit.fill,
                        image: NetworkImage("https://maps.googleapis.com/maps/api/place/photo?maxwidth=100&photoreference=$_image&key=$mapKey"),
                      ),
                    ),
                  ),
                  Container(
...
_getCurrentLocation() async {
  await geocoding.Geolocator
      .getCurrentPosition(desiredAccuracy: geocoding.LocationAccuracy.high)
 ...
 // Create the polylines for showing the route between two places
  _createPolylines(geocoding.Position start, geocoding.Position destination) async {
    polylinePoints = PolylinePoints();
  ...
  Future<bool> _calculateDistance() async {
      ...
      if (startPlacemark != null && destinationPlacemark != null) {
        ...
        geocoding.Position startCoordinates = _startAddress == _currentAddress
            ? geocoding.Position(latitude: _currentPosition.latitude, longitude: _currentPosition.longitude)
            : geocoding.Position(
        ...
        _southwestCoordinates = geocoding.Position(latitude: miny, longitude: minx);
        _northeastCoordinates = geocoding.Position(latitude: maxy, longitude: maxx);
